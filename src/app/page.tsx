          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">{t('nav.contact')}</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">{t('nav.planner')}</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">{t('nav.accommodations')}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">{t('nav.dining')}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">{t('nav.activities')}</a></li>
              </ul>
            </div>
            <div>
